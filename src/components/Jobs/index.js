...
class Jobs extends Component {
  ...
  renderLoading = () => (
    <div className="loader-container" id="loader" data-testid="loader">
      ...
      <>
        ...
        <div className="jobsContainer">
          <div className="jobsContent">
            ...
            />
            <div className="searchInputJobsListContainer">
              <div className="searchInputContainerDesktop">
                <input
                  type="search"
                ...
                >
                  <BsSearch className="searchIconDesktop" />
                </button>
              </div>
              {this.renderAllJobs()}
            </div>
